...
<head>
    ...
    <title>Jepang 8 Hari 7 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/japanlogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/jepang.jpg" width="350" height="350"></img>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Tokyo Skytree <br>
                    2. Akihabara <br>
                    3. Penyebrangan Shibuya <br>
                    4. Kuil Asakusa <br>
                    5. Disneyland dan Disneysea Tokyo 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 560 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
