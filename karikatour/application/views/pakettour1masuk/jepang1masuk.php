...
<head>
    ...
    <title>Jepang 11 Hari 10 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/japan1login')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/jepang1.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">Paket 11 Hari 10 Malam</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Berkunjunglah ke Negeri Matahri Terbit ini di saat terbaiknya. 
                Jangan lewatkan Kesempatan yang baik ini</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi"> 1. Kuil Asakusa <br>
                    2. Pedesaan Hokkaido <br>
                    3. Kuil Kuno Kyoto <br>
                    4. Gunung Fuji <br>
                    5. Kuil Osaka <br>
                    6. Disneyland dan Disneysea Tokyo
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 820 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
