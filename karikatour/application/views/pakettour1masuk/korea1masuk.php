...
<head>
    ...
    <title>Korea 9 Hari 8 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/korea1login')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/korea1.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">Paket 9 Hari 8 Malam</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi"> 1. Desa Bukchon Hanok <br>
                    2. Istana Gyeongbokgung <br>
                    3. Gunung Namsan <br>
                    4. Busan <br>
                    5. Pulau Nami <br>
                    6. Pulau Jeju
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 870 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
