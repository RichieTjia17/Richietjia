...
<head>
    ...
    <title>Korea 7 Hari 6 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/korealogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/korea.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">Paket 7 Hari 6 Malam</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Ingin lebih mengenal budaya korea selain dari K-Pop dan K-Drama ?
                Sempatkanlah waktu Anda untuk berkunjung ke negeri ginseng yang cantik dan menarik ini</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi"> 1. Seoul Tower <br>
                    2. Lotte World Seoul <br>
                    3. Distrik Myeongdong <br>
                    4. Pusat Perbelanjaan Dongdaemun <br>
                    5. Sungai Cheonggyecheon
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 610 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
