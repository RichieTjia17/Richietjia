...
<head>
    ...
    <title>Malaysia 4 Hari 3 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/malaysialogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/malaysia.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">Paket 4 Hari 3 Malam</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Meskipun bertetangga dengan Indonesia, negara yang satu ini menawarkan 
                budaya, bahasa dan kuliner yang unik. Ayo berkunjunglah ke Malaysia</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Batu Caves <br>
                    2. Jalan Petaling <br>
                    3. Pasar Seni <br>
                    4. Jalan Alor <br>
                    5. Menara Petronas <br>
                    6. Museum Negara
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 320 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
