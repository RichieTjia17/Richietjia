...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('home/pilihan');?>">Indonesian</a>
    ...
    <div class="card" style="width:45rem;">
        <div class="card-body">
            <a href="<?= base_url()?>tourpacket/<?= $pagebeforelogin;?>">
            <img src="<?= base_url();?>/gambar/<?= $source;?>" width="200px" height="200px"></img></a>
            <a class="paket" href="<?= base_url()?>tourpacket/<?= $pagebeforelogin;?>">
