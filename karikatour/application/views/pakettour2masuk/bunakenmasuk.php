...
<head>
    ...
    <title>Bunaken 3 Hari 2 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/bunakenlogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Dikenal karena memiliki pesona bawah laut yang indah, sayang jika Anda
                melewatkan kesempatan untuk menikmati keindahan taman laut ini</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Taman Laut Bunaken <br>
                    2. Desa Wisata Suku Bajo
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 200 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
