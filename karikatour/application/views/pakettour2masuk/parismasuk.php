...
<head>
    ...
    <title>Paris 8 Hari 7 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/parislogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/paris.jpg" width="350" height="350"></img>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                Perancis juga dapat dikatakan memiliki berbagai macam tempat wisata yang dapat dikunjungi, salah 
                satunya adalah Paris. Ayo, Datanglah ke kota yang dikenal akan pesona seni dan romantismenya</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Menara Eiffel <br>
                    2. Arc de Triomphe  <br>
                    3. Museum Louvre <br>
                    4. Gereja Notre Dame <br>
                    5. Istana Versailles <br>
                    6. Champs-Elysees 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 1180 (Termasuk Tiket Pesawat, Visa dan Penginapan)</p>
                </div>
            </div>
