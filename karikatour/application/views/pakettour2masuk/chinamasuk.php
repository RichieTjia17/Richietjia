...
<head>
    ...
    <title>China 7 Hari 6 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/chinalogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/china.jpg" width="350" height="350"></img>
            </div>
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Sebagai negara yang memiliki sejarah dan warisan budaya yang panjang, 
                rasanya tidak salah jika Anda mengunjungi negeri tirai bambu ini sambil belajar sejarah</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Tembok Besar <br>
                    2. Kota Terlarang <br>
                    3. Shanghai <br>
                    4. Museum Patung Terracota <br>
                    5. Kuil Surga
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 780 (Termasuk Tiket Pesawat, Visa dan Penginapan)</p>
                </div>
            </div>
