...
<head>
    ...
    <title>Lombok 4 Hari 3 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/lombok1login')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/lombok1.jpg" width="350" height="350"></img>
            </div>
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Berdekatan dengan pulau Bali, pulau yang satu ini juga sayang untuk
                Anda lewatkan keindahan alamnya</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    2. Pulau Gili  <br>
                    3. Gunung Rinjani <br>
                    4. Air terjun Sendang Gile <br>
                    5. Gili Air
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 280 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
