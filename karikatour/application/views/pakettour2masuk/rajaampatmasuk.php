...
<head>
    ...
    <title>Raja Ampat 5 Hari 4 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/rajaampatlogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Sebagai Mutiara dari timur, rasanya pas jika Anda menyempatkan waktu untuk 
                menikmati keindahan alam Raja Ampat</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 270 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
