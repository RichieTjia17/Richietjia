...
<head>
    ...
    <title>Bangkok 4 Hari 3 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/bangkoklogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Dikenal sebagai negeri gajah putih, Thailand memiliki berbagai macam 
                tempat wisata salah satunya adalah Bangkok. Ayo, eksplorasi kota Bangkok !</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 330 (Termasuk Tiket Pesawat dan Penginapan)</p>
                </div>
            </div>
