...
<head>
    ...
    <title>London 8 Hari 7 Malam</title>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacketlogin/londonlogin')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/london.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">Paket 8 Hari 7 Malam</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Sebagai salah satu negara yang cukup terkenal di benua eropa, 
                Inggris juga dapat dikatakan memiliki berbagai macam tempat wisata yang dapat dikunjungi, salah 
                satunya adalah London. Ayo, Datanglah ke London</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Big ben <br>
                    2. London Eye  <br>
                    3. Istana Buckingham <br>
                    4. Gereja Westminster Abbey <br>
                    5. Alun-alun Trafalgar <br>
                    6. Sungai Thames <br>
                    7. Museum Lilin Madame Tussaud 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Harga Paket Tour Ini : </p>
                    <p class="isi">USD$ 1120 (Termasuk Tiket Pesawat, Visa dan Penginapan)</p>
                </div>
            </div>
