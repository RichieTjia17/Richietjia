...
<html lang="en">
  <head>
    ...
    <title>Bali 5 Days 4 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/bali');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Known as the paradise on earth, Bali island provide a tourist the beautiful 
                and magnificent scenery</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Kuta Beach<br>
                    2. Pandawa Beach<br>
                    3. Bedugul Lake<br>
                    4. Benoa Cape<br>
                    5. Ubud Resort Village
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 180 (Including Flight and Accomodation)</p>
                </div>
            </div>
