...
<html lang="en">
  <head>
    ...
    <title>Japan 8 Days 7 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/jepang');?>">Indonesian</a>
        ...
        <div class="row">
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    2. Akihabara <br>
                    3. Shibuya Crossing <br>
                    4. Asakusa Temple <br>
                    5. Disneyland and Disneysea Tokyo 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 560 (Including Flight and Accomodation)</p>
                </div>
            </div>
