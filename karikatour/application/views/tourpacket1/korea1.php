...
<html lang="en">
  <head>
    ...
    <title>Korea 9 Days 8 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/korea1');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-8">
                <p class="judul">9 Days 8 Nights Packet</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi"> 1. Bukchon Hanok Village<br>
                    2. Gyeongbokgung Palace<br>
                    3. Mount Namsan <br>
                    4. Busan <br>
                    5. Nami Island<br>
                    6. Jeju Island
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 870 (Including Flight and Accomodation)</p>
                </div>
            </div>
