...
<html lang="en">
  <head>
    ...
    <title>Korea 7 Days 6 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/korea');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-8">
                <p class="judul">7 Days 6 Nights Packet</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Want to know more about korean culture besides K-Pop and K-Drama ?
                Take your time to visit to this beautiful and interesting country</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    3. Myeongdong District <br>
                    4. Dongdaemun Shopping Centre <br>
                    5. Cheonggyecheon River
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 610 (Including Flight and Accomodation)</p>
                </div>
            </div>
