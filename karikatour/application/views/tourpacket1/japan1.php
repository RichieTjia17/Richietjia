...
<html lang="en">
  <head>
    ...
    <title>Japan 11 Days 10 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/jepang1');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-8">
                <p class="judul">11 Days 10 Nights Packet</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Go to the The land of the rising star on its best time. Don't miss 
                this good opportunity</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi"> 1. Asakusa Temple<br>
                    2. Hokkaido Village <br>
                    3. Ancient Kyoto Temple <br>
                    4. Mount Fuji <br>
                    5. Osaka Palace <br>
                    6. Disneyland and Disneysea Tokyo
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 820 (Including Flight and Accomodation)</p>
                </div>
            </div>
