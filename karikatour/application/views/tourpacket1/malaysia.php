...
<html lang="en">
  <head>
    ...
    <title>Malaysia 4 Days 3 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/malaysia');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Although it's close to Indonesia, this country serves you an unique
                culture, language, and cuisine. Come on, let's go to Malaysia</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 320 (Including Flight and Accomodation)</p>
                </div>
            </div>
