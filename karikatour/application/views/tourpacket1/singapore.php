...
<html lang="en">
  <head>
    ...
    <title>Singapore 3 Days 2 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/singapura');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Although it's small, Singapore serves the tourist
                an imaginable experience. So, let's come to Singapore</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">USD$ 210 (Including Flight and Accomodation)</p>
                </div>
            </div>
