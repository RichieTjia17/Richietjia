...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('homes/choicelogin');?>">Bahasa Inggris</a>
    ...
    <div class="card" style="width:45rem;">
        <div class="card-body">
        <a href="<?= base_url()?>pakettourmasuk/<?= $lamansetelahlogin;?>">
            <img src="<?= base_url();?>/gambar/<?= $gambar;?>" width="200px" height="200px"></img></a>
            <a class="paket" href="<?= base_url()?>pakettourmasuk/<?= $lamansetelahlogin;?>">
