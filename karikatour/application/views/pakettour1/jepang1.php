        ...
        <a href="<?= base_url('auth/daftar'); ?>"><button class="daftar btn btn-success btn-outline-dark my-2 my-sm-0">Daftar</button></a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('tourpacket/japan1')?>">Bahasa Inggris</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">Berkunjunglah ke Negeri Matahari Terbit ini di saat terbaiknya. 
