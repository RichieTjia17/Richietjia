...
<html lang="en">
  <head>
    ...
    <title>London 8 Days 7 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/london');?>">Indonesian</a>
        ...
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">As one of the most well-known countries on the European continent,
                 England can also be said to have a wide variety of tourist attractions that can be visited, one
                 is London. Come on, come to London</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    4. Westminster Abbey Church<br>
                    5. Trafalgar Square<br>
                    6. River Thames <br>
                    7. Madame Tussaud Wax Museum 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 1120 (Including Flight and Accomodation)</p>
                </div>
            </div>
