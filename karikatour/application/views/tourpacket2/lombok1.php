...
<html lang="en">
  <head>
    ...
    <title>Lombok 4 Days 3 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/lombok1');?>">Indonesian</a>
        ...
        <div class="row">
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    2. Gili Island <br>
                    3. Mount Rinjani <br>
                    4. Sendang Gile Waterfall <br>
                    5. Gili Air
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 280 (Including Flight and Accomodation)</p>
                </div>
            </div>
