...
<html lang="en">
  <head>
    ...
    <title>Raja Ampat 5 Days 4 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/rajaampat');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/rajaampat.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">5 Days 4 Nights Packet</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">As the Pearl of the East, it feels just right if you take the time to
                 enjoy the natural beauty of Raja Ampat</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Raja Ampat <br>
                    2. Raja Ampat Village 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 270 (Including Flight and Accomodation)</p>
                </div>
            </div>
