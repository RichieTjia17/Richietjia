...
<html lang="en">
  <head>
    ...
    <title>China 7 Days 6 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/china');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-12">
                <p class="deskripsi">As a country that has a long history and cultural heritage,
                 it's not wrong if you visit this bamboo curtain country while studying history</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Great Wall <br>
                    2. Forbidden City <br>
                    3. Shanghai <br>
                    4. Terracota Statue Museum <br>
                    5. Heaven Palace
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 780 (Including Flight and Accomodation)</p>
                </div>
            </div>
