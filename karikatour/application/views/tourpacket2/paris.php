...
<html lang="en">
  <head>
    ...
    <title>Paris 8 Days 7 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/paris');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-lg-8">
                <p class="judul">8 Days 7 Nights Packet</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">As one of the most well-known countries on the European continent,
                 France can also be said to have various kinds of tourist attractions that can be visited, wrong
                 one is Paris. Come on, come to a city known for its artistic and romantic charm</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Eiffel Tower<br>
                    2. Arc de Triomphe  <br>
                    3. Louvre Museum<br>
                    4. Notre Dame Church<br>
                    5. Versailles Palace<br>
                    6. Champs-Elysees 
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 1180 (Including Flight and Accomodation)</p>
                </div>
            </div>
