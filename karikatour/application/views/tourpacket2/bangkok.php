...
<html lang="en">
  <head>
    ...
    <title>Bangkok 4 Days 3 Nights</title>
            ...
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="<?= base_url('pakettour/bangkok');?>">Indonesian</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col col-lg-4">
                <img src="<?= base_url()?>/gambar/bangkok.jpg" width="350" height="350"></img>
            </div>

            <div class="col col-lg-8">
                <p class="judul">4 Days 3 Nights Packet</p>
            </div>

            <div class="col col-lg-12">
                <p class="deskripsi">Known as the land of white elephants, Thailand has many kinds
                of the tourist attraction is Bangkok. Come on, explore the city of Bangkok!</p>
            </div>
            ...
            <div class="col col-lg-12">
                ...
                <div class="col">
                    ...
                    <p class="isi">1. Wat Pho Temple<br>
                    2. Floating Market <br>
                    3. Pattaya <br>
                    4. Wat Phra Temple <br>
                    5. Khaosan Street
                    </p>
                </div>
                <div class="col">
                    <p class="poin">Price of this tour packet : </p>
                    <p class="isi">USD$ 330 (Including Flight and Accomodation)</p>
                </div>
            </div>
