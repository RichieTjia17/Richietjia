...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('homes/booking');?>">Bahasa Inggris</a>
    ...
    <p class="peringatan">Mohon Maaf Pelanggan yang Terhormat</p>
    <p class="pemberitahuan">Untuk bisa melakukan pemesanan, Anda harus Mendaftarkan Akun Anda terlebih 
    dahulu atau masuk jika sudah memiliki Akun di Website Ini</p>
    <p class="panduan">Anda Dapat Meng-klik tombol <b>Masuk</b> atau <b>Daftar</b> di bagian kanan atas 
    website ini atau di bawah ini</p>
    
    <a href="<?= base_url('auth'); ?>"><button class="masuk1 btn btn-success btn-outline-dark  my-sm-0">Masuk</button></a>
    <p class="atau">Atau</p>
    <a href="<?= base_url('auth/daftar'); ?>"><button class="daftar1 btn btn-success btn-outline-dark my-sm-0">Daftar</button></a>
