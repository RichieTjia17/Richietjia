        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <a class="dropdown-item" href="<?= base_url('auth/history1');?>">Bahasa Inggris</a>
            ...
            <?php foreach ($paketan as $pak) :  ?>
                <tbody>
                    <tr>
                        ...
                        <td><img src="<?= base_url()?>/gambar/<?= $pak['gambar']; ?>" width="200"
                        height="200"></img></td>
                        <td><?= $pak['hargapaket']; ?> $</td>
                        <td>
                            <a href="" class="badge badge-pill badge-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="<?= $pak['nama_paket'];  ?>" data-whatever1="<?= $pak['pesanan_id']; ?>">Edit</a>
                            <a href="<?= base_url('auth/deleteHistory/' . $pak['pesanan_id']);  ?>" class="badge badge-pill badge-danger">Delete</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Paketan</h5>
            ...
            <?php endforeach; ?>
            <form method="POST" action="<?= base_url('Auth/history');  ?>">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Paketan Sebelumnya</label>
                        <input type="text" class="form-control" id="aa">
                    </div>
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Paketan Pengganti</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Ganti Pesanan</button>
                    </div>
                </div>
            </form>
        </div>
